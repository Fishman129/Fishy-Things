...
@OnlyIn(Dist.CLIENT)
public class CalculatorGUIGuiWindow extends ContainerScreen<CalculatorGUIGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = CalculatorGUIGui.guistate;
	TextFieldWidget no1;
	TextFieldWidget no2;
	TextFieldWidget middle;
	TextFieldWidget result;
	public CalculatorGUIGuiWindow(CalculatorGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.guiLeft + -1, this.guiTop + 0, 0, 0, 176, 166, 176, 166);
