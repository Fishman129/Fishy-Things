...
public class CalculatorGUIWhileThisGUIIsOpenTickfunction {
	public static void executefunction(Map<String, Object> dependencies) {
		if (dependencies.get("guistate") == null) {
			if (!dependencies.containsKey("guistate"))
				FishsThingsMod.LOGGER.warn("Failed to load dependency guistate for function CalculatorGUIWhileThisGUIIsOpenTick!");
			return;
		}
