...
public class MachineFrameBlock extends FishsThingsModElements.ModElement {
	@ObjectHolder("fishs_things:machine_frame")
	public static final Block block = null;
	public MachineFrameBlock(FishsThingsModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7aSafe for decoration"));
		}
