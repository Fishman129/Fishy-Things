...
import fishsthings.functions.MeatGeneratorUpdateTickfunction;
...
public class MeatGeneratorBlock extends FishsThingsModElements.ModElement {
	@ObjectHolder("fishs_things:meat_generator")
	public static final Block block = null;
	@ObjectHolder("fishs_things:meat_generator")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public MeatGeneratorBlock(FishsThingsModElements instance) {
		super(instance, 5);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("meat_generator"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("meat_generator");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				MeatGeneratorUpdateTickfunction.executefunction($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("meat_generator");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Meat Generator");
		}
