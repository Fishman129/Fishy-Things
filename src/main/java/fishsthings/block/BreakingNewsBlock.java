...
public class BreakingNewsBlock extends FishsThingsModElements.ModElement {
	@ObjectHolder("fishs_things:breaking_news_block")
	public static final Block block = null;
	public BreakingNewsBlock(FishsThingsModElements instance) {
		super(instance, 105);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("breaking_news_block");
		}
