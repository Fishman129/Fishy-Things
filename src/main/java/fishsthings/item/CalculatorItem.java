...
import fishsthings.gui.CalculatorGUIGuiWindow;
import fishsthings.gui.CalculatorGUIGui;

import fishsthings.FishsThingsModElements;

@FishsThingsModElements.ModElement.Tag
public class CalculatorItem extends FishsThingsModElements.ModElement {
	@ObjectHolder("fishs_things:simple_calculator")
	public static final Item block = null;
	public CalculatorItem(FishsThingsModElements instance) {
		super(instance, 116);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof CalculatorGUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(GeneralItemGroup.tab).maxStackSize(1).rarity(Rarity.UNCOMMON));
			setRegistryName("simple_calculator");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Basic Calculator");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new CalculatorGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
