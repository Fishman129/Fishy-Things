...
public class TeleporterGemItem extends FishsThingsModElements.ModElement {
	@ObjectHolder("fishs_things:teleporter_gem")
	public static final Item block = null;
	public TeleporterGemItem(FishsThingsModElements instance) {
		super(instance, 12);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("teleporter_gem");
		}
