...
public class FireBoneItem extends FishsThingsModElements.ModElement {
	@ObjectHolder("fishs_things:fire_bone")
	public static final Item block = null;
	public FireBoneItem(FishsThingsModElements instance) {
		super(instance, 11);
	}
