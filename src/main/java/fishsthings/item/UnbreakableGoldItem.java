...
public class UnbreakableGoldItem extends FishsThingsModElements.ModElement {
	@ObjectHolder("fishs_things:unbreakable_gold_ingot")
	public static final Item block = null;
	public UnbreakableGoldItem(FishsThingsModElements instance) {
		super(instance, 99);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("unbreakable_gold_ingot");
		}
